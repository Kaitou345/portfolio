    ...
    <div className="min-h-screen relative flex flex-col text-center md:text-left max-w-6xl px-10 justify-center items-center mx-auto gap-20 pt-20">
      ...
      <form className="grid gap-2 text-black">
        <div className="grid grid-cols-2 gap-2">
          <input
            className="h-8 p-3 focus:outline outline-orange-500  rounded-sm bg-neutral-800 caret-white placeholder-neutral-500"
            type="text"
            placeholder="Name*"
            name=""
            id=""
        ...
        />
        <textarea
          className="h-20 p-3 focus:outline outline-orange-500  rounded-sm resize-none bg-neutral-800 caret-white placeholder-neutral-500"
